...
public:
  enum {
    ...
    COLON = 55, DOT = 56, AMPERSAND = 57, L_ANGLE = 58, R_ANGLE = 59, L_ANGLE_EQ = 60, 
    R_ANGLE_EQ = 61, L_BRACE = 62, R_BRACE = 63, L_BRACKET = 64, R_BRACKET = 65, 
    L_PAREN = 66, R_PAREN = 67, SEMI = 68, COMMA = 69, EXCLAM_MARK = 70, 
